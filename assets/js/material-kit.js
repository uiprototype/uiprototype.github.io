...
$(document).ready(function(){
  ...
  $("#accounts_grid").hide();
    ...
    $("#toggle_search_advanced2").click(function(){
        $("#search_advanced2").toggle();
    });
    $("#plus").click(function(){
 ...
 * @returns {*}
 */
$.fn.cc_calendar = function (options) {
    var opts = $.extend({}, $.fn.cc_calendar_defaults(), options);
    var languageSettings = $.fn.cc_calendar_language(opts.language);
    ...
    this.each(function () {
        ...
        function drawCalendar() {
            ...
            var $containerHtml = $('<div class="cc_calendar" id="' + $calendarElement.attr('id') + '"></div>');
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><i class="fa fa-chevron-left"></i></span>');
            var $nextMonthNavIcon = $('<span><i class="fa fa-chevron-right"></i></span>');
 ...
 *   action_nav:        function
 */
$.fn.cc_calendar_defaults = function () {
    var now = new Date();
 ...
 */
$.fn.cc_calendar_language = function (lang) {
